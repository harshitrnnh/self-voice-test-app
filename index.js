...
//   substring = "weather";
  ...
  if (param.includes("weather")){speech ="<speak><audio src=\"https://www.dropbox.com/s/qquszbl6jcuhzjt/weather.mp3?dl=1\"</audio></speak>";}
  ...
  else{speech="<speak>Here are <say-as interpret-as=\"characters\">SSML</say-as> samples.</speak>"}
